...
import com.enesusta.shakosuru.controller.crypt.ICrypt;
import com.enesusta.shakosuru.controller.firebase.FirebaseInsert;
import com.enesusta.shakosuru.controller.firebase.FirebaseMessageInsert;
...
public class ActivityDers6 extends AppCompatActivity {
 ...
 /*
        ...
        */
        ...
        FirebaseMessageInsert firebaseMessageInsert = new FirebaseMessageInsert(new User());
        firebaseMessageInsert.setMainContext(getApplicationContext());
        firebaseMessageInsert.execute();
